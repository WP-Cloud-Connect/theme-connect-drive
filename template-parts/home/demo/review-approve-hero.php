<section id="review-approve-demo">
    <div class="container">
                <div class="review-approve-demo__head text-center">
                    ...
                    <p class="review-approve-demo__head-description">Allow users to review and submit selected files for approval. Admins can easily view, manage, and take action on submissions directly from the WordPress dashboard.</p>
                </div>

        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-5">
                <div class="business-head ">
                    ...
                    <h4 class="sub-hedding-title"><?php _e('Accelerate Your Business Growth', 'connect-drive'); ?></h4>
                    <div class="business-img-mobile text-center text-md-start">
                        <img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/home/business/business-illustration.png"
                            alt="business-illustration">
                    </div>
                    <p class="sub-hedding-description"><?php _e('We’re here to boost your business growth like never before. Our professional WordPress solutions are designed to increase conversions, maximize ROI, and elevate your brand image.', 'connect-drive'); ?></p>
                    <a href="/products" class="btn btn-primary"> <span><?php _e('View Products', 'connect-drive'); ?></span> <svg data-prefix="fas" data-icon="grid-2" role="img" viewBox="0 0 448 512" aria-hidden="true" class="svg-inline--fa fa-grid-2 ">

 ...
 */
function connect_drive_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
...
add_action( 'customize_register', 'connect_drive_customize' );


/**
 * Bind JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function connect_drive_customize_preview_js() {
	wp_enqueue_script( 'customizer', get_template_directory_uri() . '/inc/customizer.js', array( 'jquery' ), null, true );
}
add_action( 'customize_preview_init', 'connect_drive_customize_preview_js' );
